...
```mermaid
flowchart TD
    A[Configuration Provider<br/>Loads app-wide config] -->
    B[Auth Provider<br/>Handles login state & tokens] -->
    C[API Provider<br/>Sets up API client / fetch layer] -->
    D[Settings Provider<br/>User preferences & toggles] -->
    E[Features Provider<br/>Feature flags / experiments] -->
    F[Styles Provider<br/>Theme, colors, typography] -->
    G[Children<br/>Your actual app]
```